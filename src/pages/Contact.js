                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <CopyToClipboard text="0665901802">
                                <span classeName="clickInput" onClick={() => { alert('Numéro de téléphone copié')}}>06 65 90 18 02</span>
                            </CopyToClipboard>
                        </li>
                        <li>
                        <i className="fas fa-envelope"></i>
                            <CopyToClipboard text="mathisjancelii@gmail.com">
                                <span classeName="clickInput" onClick={() => { alert('Adresse email copié')}}>mathisjancelii@gmail.com</span>
                            </CopyToClipboard>
                        </li>
